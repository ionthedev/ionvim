...
vim.keymap.set("n", "<leader>espr", "<cmd>ESPReconfigure<CR>")
vim.keymap.set("n", "<leader>espi", "<cmd>ESPInfo<CR>")
vim.keymap.set("n", "<leader>espb", "<cmd>ESPBuild<CR>")
vim.keymap.set("n", "<leader>espp", "<cmd>pick<CR>")
vim.keymap.set("n", "<leader>espc", "<cmd>command<CR>")
